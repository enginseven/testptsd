...
ml_model_path = '../ml_models/ml_model/logistic_regression_model_pickle.pkl'
model_path = '../ml_models/nlp_model/knn_model.pkl'
vectorizer_path = '../ml_models/nlp_model/tfidf_vectorizer.pkl'
